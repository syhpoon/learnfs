...
func (c *learnFSClient) RemoveDir(ctx context.Context, in *RemoveDirRequest, opts ...grpc.CallOption) (*RemoveDirResponse, error) {
	out := new(RemoveDirResponse)
	err := c.cc.Invoke(ctx, "/learnfs.LearnFS/RemoveDir", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *learnFSClient) Statfs(ctx context.Context, in *StatfsRequest, opts ...grpc.CallOption) (*StatfsResponse, error) {
	out := new(StatfsResponse)
	err := c.cc.Invoke(ctx, "/learnfs.LearnFS/Statfs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLearnFSServer) RemoveDir(context.Context, *RemoveDirRequest) (*RemoveDirResponse, error) {
...
func _LearnFS_RemoveDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveDirRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LearnFSServer).RemoveDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/learnfs.LearnFS/RemoveDir",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LearnFSServer).RemoveDir(ctx, req.(*RemoveDirRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LearnFS_Statfs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatfsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LearnFSServer).Statfs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/learnfs.LearnFS/Statfs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LearnFSServer).Statfs(ctx, req.(*StatfsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LearnFS_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LearnFS_RemoveDir_Handler,
		},
		{
			MethodName: "SetAttr",
